...
void QCollapsible::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QCollapsible *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QCollapsible::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QCollapsible.data,
    qt_meta_data_QCollapsible,
    qt_static_metacall,
    nullptr,
    nullptr
} };
