...
void SceneInspect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SceneInspect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SceneInspect::staticMetaObject = { {
    &MainWindowTab::staticMetaObject,
    qt_meta_stringdata_SceneInspect.data,
    qt_meta_data_SceneInspect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
