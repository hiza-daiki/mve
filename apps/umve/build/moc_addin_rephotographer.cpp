...
void AddinRephotographer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinRephotographer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddinRephotographer::staticMetaObject = { {
    &AddinBase::staticMetaObject,
    qt_meta_stringdata_AddinRephotographer.data,
    qt_meta_data_AddinRephotographer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
