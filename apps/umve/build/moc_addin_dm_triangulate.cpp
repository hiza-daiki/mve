...
void AddinDMTriangulate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinDMTriangulate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddinDMTriangulate::staticMetaObject = { {
    &AddinBase::staticMetaObject,
    qt_meta_stringdata_AddinDMTriangulate.data,
    qt_meta_data_AddinDMTriangulate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
