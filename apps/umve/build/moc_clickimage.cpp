...
void ClickImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ClickImage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ClickImage::*)(int , int , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickImage::mouse_clicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ClickImage::*)(int , int , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickImage::mouse_released)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ClickImage::*)(int , int , QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickImage::mouse_moved)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ClickImage::*)(int , int , QWheelEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickImage::mouse_zoomed)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ClickImage::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_ClickImage.data,
    qt_meta_data_ClickImage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
