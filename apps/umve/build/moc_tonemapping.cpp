...
void ToneMappingHistogram::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ToneMappingHistogram *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ToneMappingHistogram::*)(float , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToneMappingHistogram::mapping_area_changed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ToneMappingHistogram::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ToneMappingHistogram.data,
    qt_meta_data_ToneMappingHistogram,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ToneMapping *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ToneMapping::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToneMapping::tone_mapping_changed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ToneMapping::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ToneMapping.data,
    qt_meta_data_ToneMapping,
    qt_static_metacall,
    nullptr,
    nullptr
} };
