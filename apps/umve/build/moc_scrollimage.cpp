...
void ScrollImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ScrollImage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ScrollImage::staticMetaObject = { {
    &QScrollArea::staticMetaObject,
    qt_meta_stringdata_ScrollImage.data,
    qt_meta_data_ScrollImage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
