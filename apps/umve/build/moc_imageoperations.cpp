...
void ImageOperationsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ImageOperationsWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ImageOperationsWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageOperationsWidget::signal_reload_embeddings)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageOperationsWidget::*)(QString const & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageOperationsWidget::signal_select_embedding)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ImageOperationsWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ImageOperationsWidget.data,
    qt_meta_data_ImageOperationsWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
