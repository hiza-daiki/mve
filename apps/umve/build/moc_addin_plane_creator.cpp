...
void AddinPlaneCreator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinPlaneCreator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddinPlaneCreator::staticMetaObject = { {
    &AddinBase::staticMetaObject,
    qt_meta_stringdata_AddinPlaneCreator.data,
    qt_meta_data_AddinPlaneCreator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
