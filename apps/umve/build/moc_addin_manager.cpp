...
void AddinManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddinManager::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_AddinManager.data,
    qt_meta_data_AddinManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddinManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ogl::CameraTrackballContext"))
        return static_cast< ogl::CameraTrackballContext*>(this);
