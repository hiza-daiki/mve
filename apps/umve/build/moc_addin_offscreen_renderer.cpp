...
void AddinOffscreenRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinOffscreenRenderer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AddinOffscreenRenderer::staticMetaObject = { {
    &AddinBase::staticMetaObject,
    qt_meta_stringdata_AddinOffscreenRenderer.data,
    qt_meta_data_AddinOffscreenRenderer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
