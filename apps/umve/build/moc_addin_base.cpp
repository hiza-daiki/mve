...
void AddinBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddinBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (AddinBase::*)(std::string const & , mve::TriangleMesh::Ptr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddinBase::mesh_generated)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AddinBase::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_AddinBase.data,
    qt_meta_data_AddinBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddinBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ogl::Context"))
        return static_cast< ogl::Context*>(this);
